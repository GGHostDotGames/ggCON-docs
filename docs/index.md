...
- **Respawn Loadouts** — the Player Spawn Plus plugin auto-gives players a configurable gear kit on first deploy, after a character re-roll, on respawn, or on demand from the panel — with optional teleport-on-spawn and per-kit cooldowns
